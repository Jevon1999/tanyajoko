...
export default function Home() {
  return (
    <div className="min-h-screen">
      {/* Navbar */}
      <nav className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm border-b border-slate-200/80 dark:border-slate-700/50 sticky top-0 z-50 shadow-sm dark:shadow-slate-900/50">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-slate-900 dark:text-white">Tanya Joko</span>
            </Link>
            <div className="flex items-center gap-6">
              <Link
                href="/destinasi"
                className="text-slate-700 dark:text-slate-300 hover:text-primary dark:hover:text-primary transition font-medium"
              >
                Destinasi
              </Link>
              <Link
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 text-blue-600 dark:text-blue-400 text-xs font-bold mb-6 border border-blue-500/20">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 dark:text-white mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-700 via-primary to-blue-600 dark:from-slate-100 dark:via-primary dark:to-blue-400">Through AI Eyes.</span>
          </h1>
          ...
          <div className="max-w-3xl mx-auto relative">
            <form className="flex items-center bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-2 border-2 border-slate-200 dark:border-slate-700 focus-within:border-primary dark:focus-within:border-primary transition-all">
              <div className="flex-shrink-0 pl-4 pr-2">
                <span className="material-icons-round text-primary">chat_bubble_outline</span>
              </div>
              <input 
                className="w-full py-4 px-2 bg-transparent border-none focus:ring-0 text-lg placeholder-slate-400 dark:placeholder-slate-500 text-slate-900 dark:text-white" 
            ...
            <div className="mt-4 flex flex-wrap justify-center gap-3 text-sm">
              <span className="text-slate-500 dark:text-slate-400">Try asking:</span>
              <button className="px-3 py-1 rounded-full bg-white dark:bg-slate-800 hover:bg-primary/10 dark:hover:bg-primary/20 transition-colors shadow-sm border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          <div>
            <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white">Trending Destinations</h2>
            <p className="text-slate-600 dark:text-slate-300 mt-2">Curated by Joko and the Jogja community.</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            <div key={index} className="group bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-slate-200 dark:border-slate-700 hover:border-primary/50 dark:hover:border-primary/50">
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-4 right-4 bg-white/95 dark:bg-slate-900/95 backdrop-blur px-3 py-1.5 rounded-xl text-xs font-bold flex items-center gap-1 shadow-lg text-slate-800 dark:text-white">
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className={`px-2 py-1 ${dest.category === 'Nature' ? 'bg-blue-500/10 text-blue-600 dark:text-blue-400' : 'bg-primary/10 text-green-700 dark:text-primary'} text-[10px] font-bold rounded uppercase tracking-wider`}>
                    {dest.category}
                  </span>
                </div>
                <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300 mb-4">{dest.description}</p>
      ...
      <section className="bg-gradient-to-b from-primary/5 to-transparent py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white mb-4">Why Choose Joko?</h2>
            <p className="text-slate-600 dark:text-slate-300">AI-powered travel assistant with local expertise</p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8">
            <div className="glass-card p-8 rounded-2xl text-center hover:shadow-xl transition-shadow duration-300">
              <div className="w-16 h-16 bg-gradient-to-br from-primary to-blue-500 rounded-2xl flex items-center justify-center mb-6 mx-auto shadow-lg">
                <span className="material-icons-round text-white text-3xl">mic</span>
              </div>
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Voice Input</h3>
            ...
            <div className="glass-card p-8 rounded-2xl text-center hover:shadow-xl transition-shadow duration-300">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-500 rounded-2xl flex items-center justify-center mb-6 mx-auto shadow-lg">
            ...
            <div className="glass-card p-8 rounded-2xl text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Smart Recommendations</h3>
              <p className="text-slate-600 dark:text-slate-300">
      ...
      {/* CTA Section */}
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 dark:from-slate-800 dark:to-slate-900 rounded-3xl p-12 text-center shadow-2xl">
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-slate-900/80 backdrop-blur">
